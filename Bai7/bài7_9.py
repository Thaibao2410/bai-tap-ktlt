...
source_file_name = 'bài 7/bảo.txt' #Gán chuỗi 'bảo.txt' (đường dẫn đến tệp nguồn) cho biến source_file_name.
destination_file_name = 'bài 7/bảo.txt'#Gán chuỗi 'bảo.txt' (đường dẫn đến tệp đích) cho biến destination_file_name.  
